...
# Get list of airports, cities, and countries
airports = list(zip(df['Airport Name'].tolist(), df['City Name'].tolist(), df['Country Name'].tolist()))
countries = df['Country Name'].unique().tolist()

def generate_map(chosen_airports):
    ...
    mst_edges, _ = prims(G, start_airport)
